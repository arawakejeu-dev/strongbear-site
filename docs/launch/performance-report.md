...
Le harnais d’ingénierie Strongbear obtient **100/100 sur 8 contrôles performance**. Le score officiel Lighthouse reste à produire sur l’URL publique finale ; aucune équivalence artificielle n’est revendiquée.
...
| Vidéo Hero responsive MP4/WebM | Conforme |
...
- **LCP :** poster Hero immédiat, versions vidéo distinctes pour ordinateur et mobile, dimensions réservées et police locale.
