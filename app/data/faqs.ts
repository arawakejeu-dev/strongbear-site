...
export const kidsFAQ: FAQItem[] = [
  ...
  { question: "Comment la sécurité est-elle assurée ?", answer: "Tous nos professeurs sont diplômés. Les exercices sont adaptés à l’âge, les contacts sont contrôlés et les binômes restent supervisés. Aucune intimidation ni recherche de puissance n’est encouragée." },
  { question: "À partir de quel âge mon enfant peut-il commencer ?", answer: "Les cours Strongbear Kids sont accessibles à partir de 6 ans. Deux groupes sont proposés : 6–10 ans et 11–14 ans. Le coach tient aussi compte de la maturité, de l’aisance et des besoins de chaque enfant." },
