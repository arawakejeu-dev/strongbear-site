...
export function FightyTrustJourney({ audience = "adult" }: { audience?: "adult" | "parent" }) {
  return <section className="section fighty-trust" aria-labelledby="fighty-trust-title"><Container>
    ...
    <div className="fighty-trust-action"><FightyCTA label={audience === "parent" ? "Réserver l’essai de mon enfant" : "Réserver mon essai gratuit"} /><span><Icon icon={ShieldCheck} size="sm" />Réservation externe sécurisée sur Fighty</span></div>
  </Container></section>;
}
