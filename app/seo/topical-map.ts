...
export const topicalClusters: TopicalCluster[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      topic({ id: "kids-age-groups", label: "Groupes d’âge", cluster: "kids", parentId: "kids", intent: "local", coverage: "published", priority: "P0", difficulty: "low", targetPath: "/kids#ages", entities: ["4–6 ans", "7–10 ans", "11–14 ans"] }),
  ...
  },
  {
    ...
    topics: [
      ...
      topic({ id: "parents-cost", label: "Tarifs et engagement Kids", cluster: "parents", parentId: "parents", intent: "commercial", coverage: "published", priority: "P0", difficulty: "low", targetPath: "/kids#tarifs", entities: ["essai gratuit", "offre Kids"] }),
